...
- [RustChain MCP](https://github.com/Scottcjn/Rustchain/tree/main/integrations/rustchain-mcp) - MCP server for RustChain blockchain — lets Claude check balances, submit jobs, view miner status, and interact with the Proof-of-Antiquity chain where vintage hardware earns RTC crypto rewards
